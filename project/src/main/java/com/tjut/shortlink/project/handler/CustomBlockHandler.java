package com.tjut.shortlink.project.handler;
...
public class CustomBlockHandler {
    ...
    public static Result<ShortLinkCreateRespDTO> createShortLinkBlockHandlerMethod(ShortLinkCreateReqDTO requestParam,
